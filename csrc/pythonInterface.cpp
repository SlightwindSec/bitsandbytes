...
extern "C"
{
  ...
  #define CMAKE_ELEMENTWISE_FUNC(fname, type_name, ctype, FUNC) \
    ...
    void cdequant_mm_int32_fp16(uint8_t *A, uint8_t *rowStats, uint8_t *colStats, uint8_t *out, uint8_t *bias, int numRows, int numCols, void *stream) {
        rowColDequant(A, rowStats, colStats, out, bias, numRows, numCols, stream);
    }
#endif
