...
// row_col_dequant
struct BlockTilingParam {
    uint64_t totalRow = 0;
    uint32_t loopNum = 0;
    uint64_t tileRow = 0;
    uint32_t tileCol = 0;
    uint16_t isTailBlockExist = 0;
    uint32_t tailRow = 0;
};
...
struct DequantizeTilingData {
    ...
    uint32_t isDoubleBuffer = 1;
    uint32_t baseBlockNum = 0;

    BlockTilingParam baseBlockTilingParam;
    BlockTilingParam tailBlockTilingParam;

    uint32_t baseTileNum = 0;
    uint32_t baseTileCol = 0;
    uint32_t tailTileCol = 0;
    uint32_t baseCoreCalcNum = 0;
    uint32_t tailCoreCalcNum = 0;
};
